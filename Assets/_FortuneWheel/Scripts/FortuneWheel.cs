namespace Curiologix
{
    ...
    public class FortuneWheel : MonoBehaviour
    {
        ...
        public Button spinButton,backBtn;
            ...
            set
            {
             ...
             //   Debug.Log("Values " + _selectReward);
                if (spinning)
                {
                   ...
                   // print()
                   // PlayerPrefs.SetInt("wheelReward", FortuneWheelConfig.Instance.prizes[_selectReward]);
                }
                else
                {
                    selectedText.text = "Spin to get Reward";
                }
            }
        }
        ...
        void Awake()
        {
            PlayerPrefs.SetInt("mk_slot_coins", 0);
